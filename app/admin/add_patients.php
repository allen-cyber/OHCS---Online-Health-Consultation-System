...
<body>
    ...
    <div class="layout-wrapper layout-content-navbar">
           ...
           <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="" id="add_patient" method="POST">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class=" mb-4">
                                        <div class="">
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="patient_name" id="nameLarge" class="form-control" placeholder="Bill Joe" />
                                        </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class=" mb-4">
                                        ...
                                        <div class="input-group">
                                            ...
                                            class="form-control phone-mask password" id="basic-default-password12"
                                            name="password"
                            ...
                            <div class="row">
                                <div class="col-sm-10 col-lg-3 mx-auto">
                                    <button type="submit" name="submit_patient" class="btn btn-primary active">Submit</button>
        ...
        <script>
            $(document).on('submit','#add_patient', function (e) {
                e.preventDefault();

                var formData = new FormData(this);
                formData.append('submit_patient', true);
