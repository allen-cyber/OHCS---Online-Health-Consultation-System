    ...
    <div class="layout-wrapper layout-content-navbar">
        <div class="layout-container">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="" id="add_doctor" method="POST">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class=" mb-4">
                                        <div class="">
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="doctor_name" id="nameLarge" class="form-control" placeholder="Bill Joe" />
                                        </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class=" mb-4">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number" name="consultancy_charge" id="nameLarge" class="form-control" placeholder="54,000" />
                                        </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class=" mb-4">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number" name="experience" id="nameLarge" class="form-control" placeholder="2 years" />
                                        </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-sm-10 col-lg-3 mx-auto">
                                    <button type="submit" name="submit_doctor" class="btn btn-primary active">Submit</button>
        ...
        <script>
            $(document).on('submit','#add_doctor', function (e) {
                ...
                formData.append('submit_doctor', true);
