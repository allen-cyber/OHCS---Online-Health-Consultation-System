...
<head>
    ...
    <!-- <meta http-equiv="refresh" id="" content="5;url=../includes/admin_security.php?logout_timeout=1" /> -->
    <!-- Favicon -->
                ...
                <nav class="layout-navbar container-xxl navbar navbar-expand-xl navbar-detached align-items-center bg-navbar-theme" id="layout-navbar">
                    ...
                    <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
                        ...
                        <div class="navbar-nav align-items-center">
                            ...
                            <h2 class="mb-0" style="text-align: center;">Administrator Dashboard</h2>
                            </div>
                        </div>
                        <!-- /Search -->
                                    ...
                                    <div class="card-body">
                                        <div class="card-title d-flex align-items-start justify-content-between">
                                            <span class="badge badge-center bg-warning">
                                                ...
                                                include('../includes/connect.php');
                                                $user_id = $_SESSION['user_role_id'];
                                                $app_SQL = "SELECT count(doctor_id) AS app_id FROM doctors";
                                        ...
                                        <h4 class="card-title text-nowrap mb-1">All</h4>
                                    ...
                                    <div class="card-body">
                                        <div class="card-title d-flex align-items-start justify-content-between">
                                            <span class="badge badge-center bg-primary">
                                                ...
                                                include('../includes/connect.php');
                                                $user_id = $_SESSION['user_role_id'];
                                                $app_SQL = "SELECT count(distinct patient_id) AS pats_count FROM appointments";
                                                $app_SQL_run = mysqli_query($con, $app_SQL);
                                                $result_count = mysqli_fetch_array($app_SQL_run);
                                                echo $result_count['pats_count'];
                                                ?> 
                                            </span>
                                        </div>
                                        <h4 class="card-title text-nowrap mb-1">All</h4>
                                        <h4 class="card-title text-nowrap mb-1">Patients</h4>
                                        <!-- <small class="text-success fw-semibold"><i class="bx bx-up-arrow-alt"></i> +28.42%</small> -->
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card-body">
                                        <div class="card-title d-flex align-items-start justify-content-between">
                                            <span class="badge badge-center bg-secondary">
                                                ...
                                                $app_SQL = "SELECT count(appointment_id) AS app_id FROM appointments";
                                                $app_SQL_run = mysqli_query($con, $app_SQL);
                                                $result_count = mysqli_fetch_array($app_SQL_run);
                                                echo $result_count['app_id'];
                                                ?> 
                                        ...
                                        <h4 class="card-title text-nowrap mb-1">All</h4>
                                        <h4 class="card-title text-nowrap mb-1">Appointments</h4>
                                        <!-- <small class="text-success fw-semibold"><i class="bx bx-up-arrow-alt"></i> +28.42%</small> -->
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card-body">
                                    <div class="card-title d-flex align-items-start justify-content-between">
                                        <span class="badge badge-center bg-dark">
                                            ...
                                            include('../includes/connect.php');
                                            $user_id = $_SESSION['user_role_id'];
                                            $app_SQL = "SELECT count(prescription_id) AS app_id FROM prescriptions";
                                            $app_SQL_run = mysqli_query($con, $app_SQL);
                                            $result_count = mysqli_fetch_array($app_SQL_run);
                                            echo $result_count['app_id'];
                                            ?> 
                                    ...
                                    <div class="card-body">
                                        <div class="card-title d-flex align-items-start justify-content-between">
                                            <span class="badge badge-center bg-danger">
                                                ...
                                                include('../includes/connect.php');
                                                $user_id = $_SESSION['user_role_id'];
                                                $app_SQL = "SELECT count(user_id) AS app_id FROM users WHERE user_role = 'admin'";
                                                $app_SQL_run = mysqli_query($con, $app_SQL);
                                                $result_count = mysqli_fetch_array($app_SQL_run);
                                                echo $result_count['app_id'];
                                                ?> 
                                        ...
                                        <h4 class="card-title text-nowrap mb-1">All</h4>
                                        <h4 class="card-title text-nowrap mb-1">Admins</h4>
                                        <!-- <small class="text-success fw-semibold"><i class="bx bx-up-arrow-alt"></i> +28.42%</small> -->
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card-body">
                                        <div class="card-title d-flex align-items-start justify-content-between">
                                            <span class="badge badge-center bg-success">
                                                ...
                                                include('../includes/connect.php');
                                                $doctor_id = $_SESSION['user_role_id'];
                                                $app_SQL = "SELECT count(treatment_id) AS app_id FROM treatments";
                                                $app_SQL_run = mysqli_query($con, $app_SQL);
                                                $result_count = mysqli_fetch_array($app_SQL_run);
                                                echo $result_count['app_id'];
                                                ?> 
                                ...
                                <div class="card-body">
                                        <div class="card-title d-flex align-items-start justify-content-between">
                                            <span class="badge badge-center bg-info">
                                                ...
                                                include('../includes/connect.php');
                                                $doctor_id = $_SESSION['user_role_id'];
                                                $app_SQL = "SELECT count(prescription_records_id) AS app_id FROM prescription_records";
                                                $app_SQL_run = mysqli_query($con, $app_SQL);
                                                $result_count = mysqli_fetch_array($app_SQL_run);
                                                echo $result_count['app_id'];
                                                ?> 
                                        ...
                                        <h4 class="card-title text-nowrap mb-1">Prescription</h4>
                                        <h4 class="card-title text-nowrap mb-1">Records</h4>
                                        <!-- <small class="text-success fw-semibold"><i class="bx bx-up-arrow-alt"></i> +28.42%</small> -->
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card-body">
                                        <div class="card-title d-flex align-items-start justify-content-between">
                                            <span class="badge badge-center bg-primary">
                                                ...
                                                include('../includes/connect.php');
                                                $doctor_id = $_SESSION['user_role_id'];
                                                $app_SQL = "SELECT count(treatment_records_id) AS app_id FROM treatment_records";
                                                $app_SQL_run = mysqli_query($con, $app_SQL);
                                                $result_count = mysqli_fetch_array($app_SQL_run);
                                                echo $result_count['app_id'];
                                                ?> 
                                        ...
                                        <h4 class="card-title text-nowrap mb-1">Treatment</h4>
                                        <h4 class="card-title text-nowrap mb-1">Records</h4>
                                        <!-- <small class="text-success fw-semibold"><i class="bx bx-up-arrow-alt"></i> +28.42%</small> -->
                                    </div>
                                </div>
                                    ...
                                    <div class="card-body">
                                        <div class="card-title d-flex align-items-start justify-content-between">
                                            <span class="badge badge-center bg-dark">
                                                ...
                                                include('../includes/connect.php');
                                                $user_id = $_SESSION['user_role_id'];
                                                $app_SQL = "SELECT count(department_id) AS app_id FROM departments";
                                                $app_SQL_run = mysqli_query($con, $app_SQL);
                                                $result_count = mysqli_fetch_array($app_SQL_run);
                                                echo $result_count['app_id'];
                                                ?> 
                                        ...
                                        <h4 class="card-title text-nowrap mb-1">All</h4>
                                        <h4 class="card-title text-nowrap mb-1">Departments</h4>
                                        <!-- <small class="text-success fw-semibold"><i class="bx bx-up-arrow-alt"></i> +28.42%</small> -->
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card-body">
                                        <div class="card-title d-flex align-items-start justify-content-between">
                                            <span class="badge badge-center bg-success">
                                                ...
                                                include('../includes/connect.php');
                                                $doctor_id = $_SESSION['user_role_id'];
                                                $app_SQL = "SELECT count(id) AS app_id FROM rooms";
                                                $app_SQL_run = mysqli_query($con, $app_SQL);
                                                $result_count = mysqli_fetch_array($app_SQL_run);
                                                echo $result_count['app_id'];
                                                ?> 
                                        ...
                                        <h4 class="card-title text-nowrap mb-1">All</h4>
                                        <h4 class="card-title text-nowrap mb-1">Rooms</h4>
                                        <!-- <small class="text-success fw-semibold"><i class="bx bx-up-arrow-alt"></i> +28.42%</small> -->
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-6 col-md-12 col-6 mb-4">
                                ...
                                <div class="card-body">
                                        <div class="card-title d-flex align-items-start justify-content-between">
                                            <span class="badge badge-center bg-warning">
                                                ...
                                                include('../includes/connect.php');
                                                $doctor_id = $_SESSION['user_role_id'];
                                                $app_SQL = "SELECT count(medicine_id) AS app_id FROM medicine";
                                                $app_SQL_run = mysqli_query($con, $app_SQL);
                                                $result_count = mysqli_fetch_array($app_SQL_run);
                                                echo $result_count['app_id'];
                                                ?> 
                                        ...
                                        <h4 class="card-title text-nowrap mb-1">All</h4>
                                        <h4 class="card-title text-nowrap mb-1">Medicines</h4>
                                        <!-- <small class="text-success fw-semibold"><i class="bx bx-up-arrow-alt"></i> +28.42%</small> -->
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-12 col-6 mb-4">
                                ...
                                <div class="card-body">
                                        ...
                                        <h4 class="card-title text-nowrap mb-1">Braah..!</h4>
                                        <h4 class="card-title text-nowrap mb-1">Braah..!</h4>
                                        <!-- <small class="text-success fw-semibold"><i class="bx bx-up-arrow-alt"></i> +28.42%</small> -->
                                    </div>
                                </div>
