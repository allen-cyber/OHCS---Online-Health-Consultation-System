            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                ...
                <div class="card">
                    ...
                    <table class="table table-hover">
                        ...
                        include('../includes/connect.php');
                        $user_id = $_SESSION['user_role_id'];
                        $pres_SQL = "SELECT * FROM prescriptions ORDER BY prescription_id DESC";
                        ...
                        <tr>
                            ...
                            <td>
                                <form action="prescription_records.php?pres_id=<?php echo  $row['prescription_id'] ?>&pat_id=<?php echo $patientID ?>&app_id=<?php echo $row['appointment_id'] ?>" method="POST">
