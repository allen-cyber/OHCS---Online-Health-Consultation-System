            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                    <nav aria-label="breadcrumb">
                        ...
                        <div class="card">
                            ...
                            <table class="table table-hover appointments_table" id="bootstrap-data-table-export">
                                <thead>
                                ...
                                <tr>
                                    ...
                                    <td>                                        
                                        <div class="dropdown">
                                            ...
                                            <a class="dropdown-item" href="appointment_report.php?id=<?php echo $row['appointment_id'] ?>"><i class="bx bx-show me-1"></i> View</a>
                                                ...
                                                <div class="col-md-6">
                                                    <div class=" mb-4">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <span class="input-group-text form-control" id="basic-addon14"><?=$_SESSION['fullname'];?> (Admin)</span>
                                                        </div>
                                                        </div>
                                                    </div>
                                                </div>
...
=
    ...
    <script>
        ...
        $(document).on('click', '#app_edit_btn', function () {
            var app_edit_id = $(this).val();
            // alert(app_edit_id);

            $.ajax({
                type: "GET",
                url: "appointment_code.php?app_edit_id="+app_edit_id,
        ...
        $(document).on('submit', '#EditAppointment', function (e) {
            ...
            var app_form_data = new FormData(this);
            app_form_data.append('save_appointment_edit_btn', true);
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if(res.status == 500){
                        ...
                        $('.appointments_table').load(location.href + ' .appointments_table');
