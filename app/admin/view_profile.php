                    ...
                    <div class="col-xxl">
                            <div class="card mb-4">
                                ...
                                if(isset($_SESSION['profile_success'])){
                                    ?>
                                    <script>
                                        swal('Good Job.!','<?php echo $_SESSION['profile_success']?>','success', {
                                            timer: 1000
                                        });
                                    </script>
                                    <?php
                                ...
                                $pro_sql = "SELECT * FROM users us JOIN admins ad ON us.user_role_id = ad.admin_id WHERE us.user_role_id = '$user_id' && ad.admin_id = '$user_id'";
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-2">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <span class="input-group-text form-control" id="basic-addon14"><?php echo $pro_result['user_role_id']; ?></span>
                                                </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class=" mb-2">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <span class="input-group-text form-control" id="basic-addon14"><?php echo $pro_result['fullname']; ?></span>
                                                </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class=" mb-2">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <span class="input-group-text form-control" id="basic-addon14"><?php echo $pro_result['email']; ?></span>
                                                </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class=" mb-2">
                                                <div class="">
                                                <div class="input-group">
                                                    <span class="input-group-text" id="basic-addon14">Profile Picture </span>
                                                    <?php
                                                    if($pro_result['profile_pic_status'] == 1){
                                                        echo "<span class='input-group-text form-control' id='basic-addon14'>Uploaded</span>";
                                                    }
                                                    else if($pro_result['profile_pic_status'] == 0){
                                                        echo "<span class='input-group-text form-control' id='basic-addon14'>Not Uploaded</span>";
                                                    }
                                                    ?>                                                </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-2">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <span class="input-group-text form-control" id="basic-addon14"><?php
                                                    $date = $pro_result['dob'];
                                        ...
                                        <div class="col-md-6">
                                            <div class=" mb-2">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <?php
                                                    if($pro_result['admin_status'] == 1){
                                                        echo "<span class='input-group-text form-control' id='basic-addon14'>Active</span>";
                                                    }
                                                    else if($pro_result['admin_status'] == 0){
                                                        echo "<span class='input-group-text form-control' id='basic-addon14'>Deactivated</span>";
                                                    }
                                                    ?>
                                                </div>
                                                </div>
                                        ...
                                        <div class="modal-dialog modal-lg modal-dialog-centered">
                                            <form class="modal-content" action="profile_code.php" method="POST">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class=" mb-4">
                                                                ...
                                                                <div class="input-group">
                                                                    <span class="input-group-text" id="basic-addon14">Full Name</span>
                                                                    <input type="text" name="profile_fullname" value="<?php echo $pro_result['fullname']; ?>" id="nameLarge" class="form-control" placeholder="Bill Joe" />
                                                                </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class=" mb-4">
                                                                ...
                                                                <div class="input-group">
                                                                    <span class="input-group-text" id="basic-addon14">Email</span>
                                                                    <input type="text" name="profile_email" value="<?php echo $pro_result['email']; ?>" id="nameLarge" class="form-control" placeholder="34" />
                                                                </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="mb-4">
                                                                <div class="">
                                                                    <div class="input-group">
                                                                        ...
                                                                        <div class="input-group">
                                                                            <span class="input-group-text" id="basic-addon14">Gender </span>
                                                                            <select class="form-select" id="inputGroupSelect01" name="profile_gender">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class=" mb-4">
                                                                ...
                                                                <div class="input-group">
                                                                    <span class="input-group-text" id="basic-addon14">Age</span>
                                                                    <input type="number" name="profile_age" value="<?php echo $pro_result['age']; ?>" id="nameLarge" class="form-control" placeholder="example@mail.com" />
                                                                </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class=" mb-4">
                                                                ...
                                                                <div class="input-group">
                                                                    <span class="input-group-text" id="basic-addon14">Contact Number</span>
                                                                    <input type="text" name="profile_contact_number" value="<?php echo $pro_result['contact_number']; ?>" id="nameLarge" class="form-control" placeholder="Bill Joe" />
                                                                </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class=" mb-4">
                                                                ...
                                                                <div class="input-group">
                                                                    <span class="input-group-text" id="basic-addon14">Postal Code</span>
                                                                    <input type="text" name="profile_postal_code" value="<?php echo $pro_result['postal_code']; ?>" id="nameLarge" class="form-control" placeholder="P.O BOX 0000" />
                                                                </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class=" mb-4">
                                                                ...
                                                                <div class="input-group">
                                                                    <span class="input-group-text" id="basic-addon14">Address</span>
                                                                    <input type="text" name="profile_address" value="<?php echo $pro_result['address']; ?>" id="nameLarge" class="form-control" placeholder="Dodoma" />
                                                                </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class=" mb-4">
                                                                ...
                                                                <div class="input-group">
                                                                    <span class="input-group-text" id="basic-addon14">City</span>
                                                                    <input type="text" name="profile_city" value="<?php echo $pro_result['city']; ?>" id="nameLarge" class="form-control" placeholder="34" />
                                                                </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class=" mb-4">
                                                                ...
                                                                <div class="input-group">
                                                                    <span class="input-group-text" id="basic-addon14">Date of Birth</span>
                                                                    <input type="date" name="profile_dob" value="<?php echo $pro_result['dob']; ?>" id="nameLarge" class="form-control" placeholder="Bill Joe" />
                                                                </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class=" mb-4">
                                                                ...
                                                                <div class="input-group">
                                                                    <span class="input-group-text" id="basic-addon14">Status</span>
                                                                    <select class="form-select" id="inputGroupSelect01" name="profile_admin_status">
                                                                        <?php
                                                                        if($pro_result['admin_status'] == 0){
                                                                            echo "<option value='1'>Active</option>";
                                                                            echo "<option selected value='0'>Not Active</option>";
                                                                        }
                                                                        else if($pro_result['admin_status'] == 1){
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <button type="submit" name="edit_profile_btn_admins" class="btn btn-primary">Save Changes</button>
                                                </div>
                                            </form>
                                        </div>
                                        </div>
