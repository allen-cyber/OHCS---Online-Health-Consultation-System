...
<body>
            ...
            <nav aria-label="breadcrumb">
                 ...
                 <div class="col-xxl">
                        <div class="card mb-4">
                            ...
                            <h3><div class="alert alert-success d-none" id="successMessage"></div></h3>
                            <h3><div class="alert alert-danger d-none" id="errorMessage"></div></h3>
                            <button type="button" onclick="history.go(-1);" class="btn btn-primary">BACK</button>
                            </div>
                            <div class="card-body">
                                <form id="formAuthentication" class="add_appointment" method="POST">
                                    <div class='row mb-3'>
                                        <label class="col-sm-2 form-label"
                                            for="basic-icon-default-gender">Appointment Type</label>
                                        <div class="col-sm-10">
                                            <div class="input-group">
                                                <select class="form-select" id="inputGroupSelect01" name="appointment_type" required>
                                    ...
                                    <div class="row mb-3">
                                        <label class="col-sm-2 form-label" for="basic-icon-default-phone">Patient
                                            ID</label>
                                        <div class="col-sm-10">
                                            <div class="input-group input-group-merge">
                                                <input type="text" id="basic-icon-default-phone"
                                                    ...
                                                    name="patient_id"
                                                    required
                                                    value="<?php echo $_SESSION['user_role_id'] ?>"
                                                    aria-describedby="basic-icon-default-phone2" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <label class="col-sm-2 form-label" for="basic-icon-default-phone">Room</label>
                                        <div class="col-sm-10">
                                            <div class="input-group input-group-merge">
                                    ...
                                    <div class="row mb-3">
                                        <label class="col-sm-2 form-label" for="basic-icon-default-calender">Appointment
                                            Date</label>
                                        <div class="col-sm-10">
                                            <div class="input-group input-group-merge">
                                    ...
                                    <div class="row mb-3">
                                        <label class="col-sm-2 form-label" for="basic-icon-default-phone">Appointment
                                            Time</label>
                                        <div class="col-sm-10">
                                            <div class="input-group input-group-merge">
                                    ...
                                    <div class='row mb-3'>
                                        <label class="col-sm-2 form-label" for="basic-icon-default">Doctor</label>
                                        <div class="col-sm-10">
                                            <div class="input-group">
                                                <select class="form-select" id="inputGroupSelect01" name="doctor_id" required>
                                                    ...
                                                    <?php
                                                    include("../includes/connect.php");
                                                    $doc_query = mysqli_query($con, "SELECT * FROM doctors WHERE doc_status = 1");
                                    ...
                                    <div class="row mb-3">
                                        <label class="col-sm-2 form-label" for="basic-icon-default-message">Appointment
                                            Reason</label>
                                        <div class="col-sm-10">
                                            <div class="input-group input-group-merge">
                                                <textarea id="basic-icon-default-message" rows="5" class="form-control"
                                    ...
                                    <div class="row justify-content-end">
                                        <div class="col-sm-10 d-grid col-lg-4 mx-auto">
                                            <button type="submit" id="add_appointment_btn" class="btn btn-primary btn-lg">Add Appointment</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
    ...
    <script>
        $(document).on('submit', '.add_appointment', function (e) {
            ...
            if(room_status_availability == false){
                swal('Sorry, No Any Room Available','CONTACT ADMINISTRATOR','error');
                // $('#add_appointment_btn').addClass('d-none');
            }
            else if(doc_status == false){
                swal('Sorry, No Any Doctor Available','CONTACT ADMINISTRATOR','error');
                // $('#add_appointment_btn').addClass('d-none');
            }
            else{
                var formData = new FormData(this);
                formData.append('send_appointment', true);
