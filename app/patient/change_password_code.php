...
if(isset($_POST['change_password_btn'])){
    ...
    $user_pass = mysqli_query($con, "SELECT pt.password FROM users us JOIN patients pt ON us.user_role_id = pt.patient_id
    WHERE us.user_role_id = '$user_id' AND pt.patient_id = '$user_id'");
    ...
    if($p_verify != 1){
        ...
        $update_pass2 = mysqli_query($con, "UPDATE patients SET password = '$new_password' WHERE patient_id = '$user_id'");
