                    ...
                    <li class="breadcrumb-item active">View Prescriptions</li>
                        ...
                        <div class="card">
                            ...
                            <table class="table table-hover">
                                ...
                                include('../includes/connect.php');
                                $user_id = $_SESSION['user_role_id'];
                                $pres_SQL = "SELECT * FROM prescriptions WHERE patient_id = '$user_id' order by prescription_id desc";
                                ...
                                <tr>
                                    ...
                                    $doc_qry = mysqli_query($con, "SELECT * FROM doctors WHERE doctor_id = '$doc_id'");
                                    $doc_rs = mysqli_fetch_array($doc_qry);
                                    echo $doc_rs['doctor_name'];
                                    ?></td>
                                    <td><?php
                                    $pat_id = $row['patient_id'];
                                    $pat_qry = mysqli_query($con, "SELECT * FROM patients WHERE patient_id = '$pat_id'");
                                    $pat_rs = mysqli_fetch_array($pat_qry);
                                    echo $pat_rs['patient_name'];
                                    ?></td>
                                    <td><?php 
                                    ...
                                    <td>
                                        ...
                                        <form action="new_prescription_code.php?pres_id=<?php echo  $row['prescription_id'] ?>&pat_id=<?php echo $user_id ?>&app_id=<?php echo $row['prescription_id'] ?>" method="POST">
                                            <button type="submit" name="delete_appointment" class="btn btn-primary btn-xs">View</button>
