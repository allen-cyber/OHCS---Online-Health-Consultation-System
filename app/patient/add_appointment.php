...
<body>
            ...
            <nav aria-label="breadcrumb">
                 ...
                 <div class="col-xxl">
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <form class="mb-3" id="add_appointment" method="POST">
                                    <div class='row mb-3'>
                                        <label class="col-sm-2 form-label"
                                            for="basic-icon-default-gender">Appointment Type</label>
                                        <div class="col-sm-10">
                                            <div class="input-group">
                                                <select class="form-select" id="inputGroupSelect01" autofocus name="appointment_type" required>
                                    ...
                                    <div class="row justify-content-end">
                                        <div class="col-sm-10 d-grid col-lg-4 mx-auto">
                                            <button type="submit" name="send_appointment" class="btn btn-primary btn-lg">Add Appointment</button>
                                        </div>
                                    </div>
    ...
    <script>
        $(document).on('submit', '#add_appointment', function (e) {
            ...
            form_data.append('send_appointment', true);
