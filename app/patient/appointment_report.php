                                    ...
                                    <div class="card accordion-item">
                                        ...
                                        >
                                            <div class="accordion-body">
                                                ...
                                                $app_sql1 = "SELECT * FROM appointments WHERE appointment_id = '$app_id' && patient_id = '$user_id'";
                                        ...
                                        >
                                            <div class="accordion-body">
                                                ...
                                                $app_id = $_GET['id'];
                                                // $pro_sql = "SELECT * FROM patients WHERE patient_id = '$user_id'";
                                                $app_sql3 = "SELECT * FROM appointments WHERE appointment_id = '$app_id' && patient_id = '$user_id'";
                                                $app_sql_run3 = mysqli_query($con, $app_sql3);
                                                $app_result3 = mysqli_fetch_array($app_sql_run3);
                                                $doctor_id = $app_result3['doctor_id'];

                                                $app_sql2 = "SELECT * FROM doctors WHERE doctor_id = '$doctor_id'";
                                        ...
                                        >
                                            ...
                                            <div class="card">
                                                ...
                                                <table class="table table-hover ">
                                                    ...
                                                    <?php
                                                    $tret_sql = "SELECT * FROM treatments WHERE appointment_id = '$app_id' && patient_id = '$user_id'";
                                            ...
                                            <div class="accordion-body">
                                                ...
                                                <div class="card">
                                                    ...
                                                    <table class="table table-hover">
                                                        ...
                                                        include('../includes/connect.php');
                                                        $user_id = $_SESSION['user_role_id'];
                                                        $pres_SQL = "SELECT * FROM prescriptions WHERE patient_id = '$user_id' && appointment_id = '$app_id'";
                                                        ...
                                                        <tr>
                                                            ...
                                                            ?> 
                                                            <form action="new_prescription_code.php?pres_id=<?php echo  $row['prescription_id'] ?>&pat_id=<?php echo $doctor_id ?>&app_id=<?php echo $app_id ?>" method="POST">
                                                                <button type="submit" name="delete_appointment" class="btn btn-primary btn-sm">View</button>
