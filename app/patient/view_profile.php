...
<body>
            ...
            <!-- Content -->
                    ...
                    <div class="col-xxl">
                            <div class="card mb-4">
                                ...
                                ?>
                                <button type="button" id="add_patient_profile_btn" class="btn btn-primary d-none">Add Profile</button>
                                
                                <!-- Modal -->
                                <div class="modal fade" id="backAddProfileDropModal" data-bs-backdrop="static" tabindex="-1">
                                    <div class="modal-dialog modal-lg">
                                        <form class="modal-content" id="add_patient_profile" method="POST">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="backDropModalTitle">Add Profile</h5>
                                                <button
                                                type="button"
                                                class="btn-close"
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class=" mb-4">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <span class="input-group-text form-control" id="basic-addon14"><?=$_SESSION['user_role_id']?></span>
                                                            </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class=" mb-4">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" name="patient_name" value="<?= $_SESSION['fullname'] ?>" id="nameLarge" class="form-control" placeholder="Bill Joe" />
                                                            </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="mb-4">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" name="pincode" id="nameLarge" class="form-control" placeholder="P.O BOX 00000" />
                                                            </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                            ...
                                                            <div class="">
                                                                <div class="input-group">
                                                                    ...
                                                                    <span class="input-group-text" id="basic-addon14">Blood Group </span>
                                                                        <select class="form-select" id="inputGroupSelect01" name="blood_group">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class=" mb-4">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input type="date" name="dob" id="nameLarge" class="form-control" placeholder="2020-12-21" />
                                                            </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <button type="submit" name="edit_profile_btn" class="btn btn-primary">Save</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
                                ...
                                if(mysqli_num_rows($pat_pic_pro) > 0){
                                    ?>
                                    <div class="card-body" id="profile_pic_card">
                                ...
                                ?>
                                    <div id="patient_record">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class=" mb-4">
                                                    ...
                                                    <div class="input-group">
                                                        <span class="input-group-text" id="basic-addon14">Postal Code </span>
                                                        <span class="input-group-text form-control" id="basic-addon14"><?php echo $pro_result['pincode']; ?></span>
                                                    </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="mb-4">
                                                    ...
                                                    <div class="input-group">
                                                        <span class="input-group-text" id="basic-addon14">Blood Group </span>
                                                        <span class="input-group-text form-control" id="basic-addon14"><?= $pro_result['blood_group']; ?></span>
                                                        <!-- <select class="form-select" id="inputGroupSelect01" name="blood_group">
                                                            <option value="<?= $pro_result['blood_group']; ?>"><?= $pro_result['blood_group']; ?></option>
                                                            <option value="A">A</option>
                                                            <option value="B">B</option>
                                                            <option value="AB">AB</option>
                                                            <option value="O">O</option>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="mb-4">
                                                    ...
                                                    <div class="input-group">
                                                        <span class="input-group-text" id="basic-addon14">Date of birth </span>
                                                        <span class="input-group-text form-control" id="basic-addon14"><?php echo $pro_result['dob']; ?></span>
                                                    </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row justify-content-end">
                                            <div class="col-sm-10 d-grid col-lg-3 mx-auto">
                                                <button type="submit" data-bs-toggle="modal" data-bs-target="#backDropModal" name="edit_profile" class="btn btn-primary btn-lg">Edit Profile</button>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- Modal -->
                                    <div class="modal fade" id="backDropModal" data-bs-backdrop="static" tabindex="-1">
                                        <div class="modal-dialog modal-lg">
                                            <form class="modal-content" action="profile_code.php" method="POST">
                                                <div class="modal-header">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class=" mb-4">
                                                                ...
                                                                <div class="input-group">
                                                                    <span class="input-group-text" id="basic-addon14">Full Name</span>
                                                                    <input type="text" name="patient_name" value="<?php echo $pro_result['patient_name']; ?>" id="nameLarge" class="form-control" placeholder="Bill Joe" />
                                                                </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="mb-4">
                                                                ...
                                                                <div class="input-group">
                                                                    <span class="input-group-text" id="basic-addon14">Postal code </span>
                                                                    <input type="text" name="pincode" value="<?php echo $pro_result['pincode']; ?>" id="nameLarge" class="form-control" placeholder="P.O BOX 00000" />
                                                                </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class=" mb-4">
                                                                ...
                                                                <div class="input-group">
                                                                    <span class="input-group-text" id="basic-addon14">Blood Group </span>
                                                                    <!-- <input type="text" name="blood_group" value="<?php #echo $pro_result['blood_group']; ?>" id="nameLarge" class="form-control" placeholder="A+" /> -->
                                                                    <select class="form-select" id="inputGroupSelect01" name="blood_group">
                                                                        <option value="<?php echo $pro_result['blood_group']; ?>"><?php echo $pro_result['blood_group']; ?></option>
                                                                        <option value="A">A</option>
                                                                        <option value="B">B</option>
                                                                        <option value="AB">AB</option>
                                                                        <option value="O">O</option>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class=" mb-4">
                                                                ...
                                                                <div class="input-group">
                                                                    <span class="input-group-text" id="basic-addon14">Date of birth </span>
                                                                    <input type="date" name="dob" value="<?php echo $pro_result['dob']; ?>" id="nameLarge" class="form-control" placeholder="2020-12-21" />
                                                                </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <button type="submit" name="edit_profile_btn" class="btn btn-primary">Update</button>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
                                ...
                                <?php
                                    ...
                                    echo "<h3><div class='alert alert-danger' role='alert'>No Data Found, Add Profile</div></h3>";
                                    
                                    ?>
                                    <script>
                                            $('#add_patient_profile_btn').removeClass('d-none');                                            
                                    </script>
                                    <?php
                                }
                                ?>
    ...
    <script>
        $(document).on('click', '#add_patient_profile_btn', function () {
            $('#backAddProfileDropModal').modal('show');
        });

        $(document).on('submit', '#add_patient_profile', function (e) {
            e.preventDefault();

            var form = new FormData(this);
            form.append('save_patient_profile', true);
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if(res.status == 200){
                        $('#backAddProfileDropModal').modal('hide');
                        $('#add_patient_profile')[0].reset();
                        $('#profile_pic_card').removeClass('d-none');
                        $('#patient_record').load(location.href + ' #patient_record');
                        location.reload();
...
<script>
    ...
    $(document).on('click', '#dp_reset_btn', function () {
        ...
        $.ajax({
            type: "GET",
            url: "profile_code.php?dp_reset_id=" + profile_reset_btn,
            success: function (response) {
                var res = $.parseJSON(response);
                if(res.status == 500){
                    swal('Ooops..!',res.message,'error');
