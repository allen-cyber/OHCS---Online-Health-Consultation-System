            ...
            <nav aria-label="breadcrumb">
                 ...
                 <div class="col-xxl">
                        <div class="card mb-4">
                            ...
                            ?>
                            <form id="formAuthentication" class="mb-3" action="appointment_code.php" method="POST">
                                <div class="row">
                                ...
                                <div class="row g-2">
                                    <div class='col mb-4'>
                                        <label class="form-label"
                                            for="basic-icon-default-gender">Appointment Type</label>
                                        <div class="col-sm-10">
                                            <div class="input-group">
                                                
                                                <select class="form-select" id="inputGroupSelect01" name="appointment_type">
                                                    <option value="<?php echo $result['appointment_type'] ?>"><?php echo $result['appointment_type'] ?></option>
                                    ...
                                    <div class="col mb-4">
                                        <label class="form-label" for="basic-icon-default-phone">Patient
                                            ID</label>
                                        <div class="col-sm-10">
                                            <div class="input-group input-group-merge">
                                                <span type="text" id="basic-icon-default-phone"
                                                    class="form-control phone-mask" placeholder="PT112532"
                                                    aria-label="PT112532"
                                                    name="patient_id"
                                                    aria-describedby="basic-icon-default-phone2"><?php echo $result['patient_id'] ?></span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row g-2">
                                    <div class="col mb-4">
                                        <label class="form-label" for="basic-icon-default-phone">Room
                                            ID</label>
                                        <div class="col-sm-10">
                                            <div class="input-group input-group-merge">
                                                <select class="form-select" id="inputGroupSelect01" name="room_id" required>
                                                    <option >Select</option>                                              
                                                    <?php
                                                    include('../includes/connect.php');
                                                    $room_id = $result['room_id'];
                                                    $selected_room = mysqli_query($con, "SELECT * FROM rooms WHERE room_id = '$room_id'");
                                                    $rom_rs = mysqli_fetch_array($selected_room);
                                                    ?>
                                                    <option selected value="<?php echo $rom_rs['room_id']?>"><?php echo $rom_rs['room_type']?>, <?php echo $rom_rs['room_number']?>, <?php echo $rom_rs['room_size']?></option>
                                                    <?php
                                                    $rooms_query = mysqli_query($con, "SELECT * FROM rooms WHERE status = 1 AND room_id != '$room_id'");
                                ...
                                <div class="row g-2">
                                    <div class="col mb-4">
                                        <label class="form-label" for="basic-icon-default-calender">Appointment
                                            Date</label>
                                        <div class="col-sm-10">
                                            <div class="input-group input-group-merge">
                                                <input type="date" id="basic-icon-default-calender" class="form-control"
                                                value="<?php echo $result['appointment_date'] ?>"
                                                    aria-describedby="basic-icon-default-calender" name="appointment_date" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col mb-4">
                                        <label class="form-label" for="basic-icon-default-phone">Appointment
                                            Time</label>
                                        <div class="col-sm-10">
                                            <div class="input-group input-group-merge">
                                                <input type="time" id="basic-icon-default-time"
                                                    class="form-control phone-mask" onfocus="(this.type='time')"
                                                    value="<?php echo $result['appointment_time'] ?>"
                                ...
                                <div class="row g-2">
                                    <div class='col mb-4'>
                                        <label class="form-label" for="basic-icon-default">Doctor</label>
                                        <div class="col-sm-10">
                                            <div class="input-group">
                                                <select class="form-select" id="inputGroupSelect01" name="doctor_id" required>
                                                    <option >Select</option>
                                                    <?php
                                                    include("../includes/connect.php");
                                                    $doc_id = $result['doctor_id'];
                                                    $doc_selected = mysqli_query($con, "SELECT doctor_id, doctor_name FROM doctors WHERE doctor_id = '$doc_id'");
                                                    $doc_rs = mysqli_fetch_array($doc_selected);
                                                    ?>
                                                    <option selected value="<?php echo $doc_rs['doctor_id']?>">Dr. <?php echo $doc_rs['doctor_name'] ?> </option>
                                                    <?php
                                                    $doc_query = mysqli_query($con, "SELECT * FROM doctors WHERE doc_status = 1 AND doctor_id != '$doc_id'");
                                                    if(mysqli_num_rows($doc_query) > 0){
                                                        ...
                                                        ?>
                                                        <option style="color: red;">No Any Available Doctor</option>
                                                        <script>
                                    ...
                                    <div class="col mb-4">
                                        <label class="form-label" for="basic-icon-default-message">Appointment
                                            Reason</label>
                                        <div class="col-sm-10">
                                            <div class="input-group input-group-merge">
                                                ...
                                                name="appointment_reason"
                                                    ...
                                                    aria-describedby="basic-icon-default-message2"><?php echo $result['appointment_reason'] ?></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-10 col-lg-3 mx-auto">
                                            <button type="submit" name="update_appointment" class="btn btn-primary active">Update</button>
                                            <a href="view_appointments.php" class="btn btn-secondary active" >Cancel</a>
                                        </div>
                                    </div>
                            </form>
                            </div>
