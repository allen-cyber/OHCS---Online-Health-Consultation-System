                                ...
                                <form id="formAuthentication" class="add_appointment" method="POST">
                                        ...
                                        <div class="col-sm-10">
                                            <div class="input-group">
                                                <select class="form-select" id="inputGroupSelect01" name="doctor_id" required>
                                                    ...
                                                    <?php
                                                    include("../includes/connect.php");
                                                    $doc_query = mysqli_query($con, "SELECT * FROM doctors WHERE doc_status = 1 AND doctor_id != '$user_id'");
                                    ...
                                    <div class="row justify-content-end">
                                        <div class="col-sm-10 d-grid col-lg-4 mx-auto">
                                            <button type="submit" class="btn btn-primary btn-lg">Add Appointment</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
