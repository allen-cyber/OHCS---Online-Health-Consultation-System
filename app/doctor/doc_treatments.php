                    ...
                    <li class="breadcrumb-item active">View Treatments</li>
                        ...
                        <div class="card">
                            ...
                            <table class="table table-hover">
                                ...
                                include('../includes/connect.php');
                                $user_id = $_SESSION['user_role_id'];
                                $treat_SQL = "SELECT * FROM treatments WHERE doctor_id = '$user_id' ORDER BY treatment_id DESC";
                                ...
                                <tr>
                                    ...
                                    <td>
                                    <a href="../doctor/treatment_uploads/<?php echo $row['uploads']?>" download class="btn btn-xs btn-primary">Download</a>
                                    </td>
                                    <td><?php
