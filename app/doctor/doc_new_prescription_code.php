...
include("../includes/doc_security_new_prescription.php");
?>
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                <nav aria-label="breadcrumb">
                    ...
                    <li class="breadcrumb-item">
                        <a href="javascript:void(0);">Appoitnment</a>
                    </li>
                    <li class="breadcrumb-item">
                        <a href="javascript:void(0);">Appoitnment Report</a>
                    </li>
                ...
                <div class="card mb-3">
                    <div class="card-header d-flex align-items-center justify-content-between">
                        ...
                        <h3 class="mb-0">Add New Prescription Record</h3>
                        <?php
                        $app_id = $_GET['app_id'];
                        if(isset($_SESSION['prescription_success'])){
                            echo "<h3><div class='alert alert-success alert-dismissible' role='alert'>".
                            ($_SESSION['prescription_success'])
                            ."<button type='button' class='btn-close' data-bs-dismiss='alert' aria-label='Close'></button>
                            </div></h3>";
                            unset($_SESSION['prescription_success']);
                        }
                        if(isset($_SESSION['rec_del_success'])){
                            echo "<h3><div class='alert alert-danger alert-dismissible' role='alert'>".
                            ($_SESSION['rec_del_success'])
                            ."<button type='button' class='btn-close' data-bs-dismiss='alert' aria-label='Close'></button>
                            </div></h3>";
                            unset($_SESSION['rec_del_success']);
                        }
                        ?>
                    ...
                    <table class="table table-hover">
                        ...
                        $pres_SQL = "SELECT * FROM prescriptions WHERE doctor_id = '$user_id' AND prescription_id = '$pres_id'";
                        ...
                        <tr>
                            ...
                            if($_SESSION['user_role'] == 'doctor'){
                                ...
                                <form action="appointment_code.php" method="POST">
                                    <button type="submit" name="pres_delete_btn" class="btn btn-danger btn-sm"><i class="bx bx-trash me-1"></i></button>
                                    <input type="hidden" name="pres_delete_id" value = "<?php echo $pres_id ?>">
                                    <input type="hidden" name="app_del_id" value = "<?php echo $app_id ?>">
                                </form>
                                </div>
                                <?php
                            }
                ...
                <div class="card mb-3">
                        <div class="card-body">
                            <form action="appointment_code.php?app_id=<?php echo $app_id?>&pat_id=<?php echo $pat_id?>&pres_id=<?php echo $pres_id?>" method="POST">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="mb-4">
                                            <div class="">
                                            <div class="input-group">
                                                <span class="input-group-text" id="basic-addon14">Medicine</span>
                                                <select class="form-select" id="inputGroupSelect01" name="medicine">
                                                    <option value="">Select</option>
                                                    <?php
                                                    $med_select_query = mysqli_query($con, "SELECT * FROM medicine WHERE status = 1");
                                                    while ($med_rs = mysqli_fetch_array($med_select_query)){ 
                                                        ?>
                                                            <option value="<?php echo $med_rs['medicine_id']?>"><?php echo $med_rs['medicine_name']." - (".$med_rs['medicine_cost'].")" ?></option>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="mb-4">
                                            <div class="">
                                            <div class="input-group">
                                                <span class="input-group-text" id="basic-addon14">Unit</span>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="mb-4">
                                            <div class="">
                                            <div class="input-group">
                                                <span class="input-group-text" id="basic-addon14">Dosage</span>
                                                <select class="form-select" id="inputGroupSelect01" name="dosage">
                                                    <option value="">Select</option>
                                ...
                                <div class="row">
                                    <div class="col-sm-10 col-lg-3 mx-auto">
                                        <button type="submit" name="add_new_prescription" class="btn btn-primary active">Submit</button>
                                        <button type="reset" class="btn btn-secondary active" >Reset</button>
                                    </div>
                                </div>
                            </form>
                        </div>
                ...
                <div class="card">
                    ...
                    <div class="table-responsive text-nowrap mb-3">
                        <table class="table table-hover">
                            ...
                            include('../includes/connect.php');
                            $user_id = $_SESSION['user_role_id'];
                            $pres_SQL = "SELECT * FROM prescription_records WHERE prescription_id = '$pres_id'";
                            $pres_SQL_run = mysqli_query($con, $pres_SQL);
                            if(mysqli_num_rows($pres_SQL_run) > 0){
                            # $data = mysqli_fetch_array($pres_SQL_run);
                                while ($row = mysqli_fetch_array($pres_SQL_run)){
                            ...
                            <tr>
                                ...
                                <td>
                                <form action="appointment_code.php?app_id=<?php echo $app_id?>&pat_id=<?php echo $pat_id?>&pres_id=<?php echo $pres_id?>" method="POST">
                                    <button type="submit" name="pres_record_delete_btn" class="btn btn-danger btn-sm"><i class="bx bx-trash me-1"></i></button>
                                    <input type="hidden" name="pres_delete_id" value = "<?php echo $row['prescription_records_id'] ?>">
                                    <input type="hidden" name="app_del_id" value = "<?php echo $app_id ?>">
                                </form>                                </td>
                            </tr>
                            <?php
                    ...
                    <div class="row g-2">
                        ...
                        <div class="col-md-4">
                            <div class="mb-4">
                                <div class="">
                                <div class="input-group">
                                    <span class="input-group-text" id="basic-addon14">Grand Total</span>
                                    <span class="input-group-text" id="basic-addon14">
                                        <?php
                                        $tot = mysqli_query($con, "SELECT sum(total_cost) as grand_total FROM prescription_records WHERE prescription_id = '$pres_id'");
                                        $tot_res = mysqli_fetch_array($tot);
                                        echo $tot_res['grand_total'];
                                        ?>/=
                                    </span>
                                </div>
                                </div>
