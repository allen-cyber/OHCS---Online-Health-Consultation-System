                    ...
                    <nav aria-label="breadcrumb">
                        ...
                        <div class="card">
                            ...
                            <table class="table table-hover appointment_table" id="bootstrap-data-table-export">
                                ...
                                include('../includes/connect.php');
                                $user_id = $_SESSION['user_role_id'];
                                $app_SQL = "SELECT * FROM appointments WHERE doctor_id = '$user_id' && appointment_status = 1 ORDER BY appointment_id DESC";
                                ...
                                <tr>
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <form action="appointment_code.php" method="POST">
                                            <button type="submit" name="disapprove_appointment" class="dropdown-item"><i class="bx bx-layout me-1"></i>Disapprove</button>
