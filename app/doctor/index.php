                                    ...
                                    <div class="d-flex justify-content-between flex-sm-row flex-column gap-3">
                                        <div class="d-flex flex-sm-column flex-row align-items-start justify-content-between">
                                            ...
                                            <div class="mt-sm-auto">
                                                ...
                                                <h5><span class="text-light fw-semibold">Doctor ID:  </span><?php echo $_SESSION['user_role_id'];?></h5>
                                    ...
                                    <div class="card-body">
                                        <div class="card-title d-flex align-items-start justify-content-between">
                                            <span class="badge badge-center bg-warning">
                                                ...
                                                include('../includes/connect.php');
                                                $user_id = $_SESSION['user_role_id'];
                                                $app_SQL = "SELECT count(appointment_id) AS app_id FROM appointments WHERE doctor_id = '$user_id' && appointment_status = 0";
                                ...
                                <div class="card-body">
                                        <div class="card-title d-flex align-items-start justify-content-between">
                                            <span class="badge badge-center bg-success">
                                                ...
                                                $app_SQL = "SELECT count(appointment_id) AS app_id FROM appointments WHERE doctor_id = '$doctor_id' && appointment_status = 1";
                                                $app_SQL_run = mysqli_query($con, $app_SQL);
                                                $result_count = mysqli_fetch_array($app_SQL_run);
                                                echo $result_count['app_id'];
                                                ?> 
                                    ...
                                    <div class="card-body">
                                        <div class="card-title d-flex align-items-start justify-content-between">
                                            <span class="badge badge-center bg-dark">
                                                ...
                                                include('../includes/connect.php');
                                                $user_id = $_SESSION['user_role_id'];
                                                $app_SQL = "SELECT count(prescription_id) AS app_id FROM prescriptions WHERE doctor_id = '$user_id'";
                                                $app_SQL_run = mysqli_query($con, $app_SQL);
                                                $result_count = mysqli_fetch_array($app_SQL_run);
                                                echo $result_count['app_id'];
                                                ?> 
                                ...
                                <div class="card-body">
                                        <div class="card-title d-flex align-items-start justify-content-between">
                                            <span class="badge badge-center bg-info">
                                                ...
                                                include('../includes/connect.php');
                                                $doctor_id = $_SESSION['user_role_id'];
                                                $app_SQL = "SELECT count(treatment_id) AS app_id FROM treatments WHERE doctor_id = '$doctor_id'";
                                                $app_SQL_run = mysqli_query($con, $app_SQL);
                                                $result_count = mysqli_fetch_array($app_SQL_run);
                                                echo $result_count['app_id'];
                                                ?> 
                                ...
                                <div class="card-body">
                                        <div class="card-title d-flex align-items-start justify-content-between">
                                            <span class="badge badge-center bg-secondary">
                                                ...
                                                include('../includes/connect.php');
                                                $doctor_id = $_SESSION['user_role_id'];
                                                $app_SQL = "SELECT count(appointment_id) AS app_id FROM appointments WHERE doctor_id = '$doctor_id'";
                                                $app_SQL_run = mysqli_query($con, $app_SQL);
                                                $result_count = mysqli_fetch_array($app_SQL_run);
                                                echo $result_count['app_id'];
                                                ?> 
                                    ...
                                    <div class="card-body">
                                        <div class="card-title d-flex align-items-start justify-content-between">
                                            <span class="badge badge-center bg-primary">
                                                ...
                                                include('../includes/connect.php');
                                                $user_id = $_SESSION['user_role_id'];
                                                $app_SQL = "SELECT count(distinct patient_id) AS pats_count FROM appointments WHERE doctor_id = '$user_id'";
                                                $app_SQL_run = mysqli_query($con, $app_SQL);
                                                $result_count = mysqli_fetch_array($app_SQL_run);
                            ...
                            <div class="col-lg-6 col-md-12 col-6 mb-4">
                                <div class="card mb-4">
                                    <div class="card-body">
                                        ...
                                        <span>Brah..! Brah..!</span>
                                        <h4 class="card-title text-nowrap mb-1">Brah..!Brah..!</h4>
                                        <!-- <small class="text-success fw-semibold"><i class="bx bx-up-arrow-alt"></i> +28.42%</small> -->
                                    </div>
                                </div>
                            </div>
