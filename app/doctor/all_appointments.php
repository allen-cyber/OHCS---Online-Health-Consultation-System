        ...
        <div class="layout-container">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                    <nav aria-label="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">View All Appointments</li>
                        </ol>
                    </nav>
                        ...
                        <div class="card">
                            ...
                            <table class="table table-hover" id="bootstrap-data-table-export">
                                ...
                                include('../includes/connect.php');
                                $user_id = $_SESSION['user_role_id'];
                                $app_SQL = "SELECT * FROM appointments WHERE doctor_id = '$user_id' ORDER BY appointment_id DESC";
                                ...
                                <tr>
                                    ...
                                    <td><?php echo 'Dr. '.$_SESSION['fullname']; ?></td>
                                    ...
                                    if($row['appointment_status'] == 0){
                                        ...
                                        echo "<td><span class='badge bg-label-success me-1'>Completed</span></td>";
                                    }
                                    ?>    
                                    <td><?php echo wordwrap($row['appointment_reason'], 40, '</br>'); ?></td>
                                    <td>
                                        <a class="btn btn-primary btn-xs" href="appointment_report.php?id=<?php echo $row['appointment_id'] ?> "
