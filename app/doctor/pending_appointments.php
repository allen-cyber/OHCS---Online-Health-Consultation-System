        ...
        <div class="layout-container">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                    <nav aria-label="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">View Pending Appointments</li>
                        </ol>
                    </nav>
                        ...
                        <div class="card">
                            ...
                            <table class="table table-hover" id="bootstrap-data-table-export">
                                ...
                                include('../includes/connect.php');
                                $user_id = $_SESSION['user_role_id'];
                                $app_SQL = "SELECT * FROM appointments WHERE doctor_id = '$user_id' && appointment_status = 0 ORDER BY appointment_id DESC";
                                ...
                                <tr>
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <form action="appointment_code.php" method="POST">
                                            <button type="submit" name="approve_appointment" class="dropdown-item"><i class="bx bx-layout me-1"></i>Approve</button>
